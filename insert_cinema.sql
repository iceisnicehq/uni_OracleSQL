...
VALUES ('Начало', 'Фильм о вторжении в сознание через сны', DATE '2010-07-16', 'США', 'Фильм', '16+', 'Английский', 'Да');

INSERT INTO Content (title, synopsis, release_date, country, type, age_rating, language, dubbing)
VALUES ('Паразиты', 'Драматическая история о классовом неравенстве', DATE '2019-05-30', 'Южная Корея', 'Фильм', '18+', 'Корейский', 'Нет');

INSERT INTO Content (title, synopsis, release_date, country, type, age_rating, language, dubbing)
VALUES ('Ведьмак', 'Фэнтезийная сага о приключениях Геральта', DATE '2019-12-20', 'Польша', 'Сериал', '18+', 'Английский', 'Да');
-----------------------------------------------------------------------------------
